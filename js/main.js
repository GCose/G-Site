...
ScrollReveal().reveal(".about-img, .media-icons i, .contact-left li", {
  delay: 200,
  origin: "left",
  interval: 200,
});

ScrollReveal().reveal(".home-img, .about .description", {
  delay: 200,
  origin: "bottom",
});
...
ScrollReveal().reveal(
  ".about, footer .group, .contact-right, .professional-list li",
  {
    delay: 200,
    origin: "top",
    interval: 200,
